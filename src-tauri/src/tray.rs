use tauri::{SystemTray, CustomMenuItem, SystemTrayMenu, SystemTrayMenuItem,SystemTrayEvent, AppHandle, Manager};

// 托盘菜单
pub fn menu() -> SystemTray {
    let tray_menu = SystemTrayMenu::new()
        .add_item(CustomMenuItem::new("setting".to_string(), "Setting")) // 隐藏应用窗口
...
pub fn handler(app: &AppHandle, event: SystemTrayEvent) {
    ...
    let setting_window = app.get_window("setting").unwrap();
